<template>
    <div class="login_body">
        ...
        <div>
            <input type="text" v-model="verifyImg" class="login_text" placeholder="验证码"><img @click="handleToVerifyImg" :src='updateverifyTmg' alt="">
        </div>
        <div class="login_btn">
...
export default {
    ...
    data(){
        return{
            ...
            password: '',
            verifyImg :'',
            updateverifyTmg : '/api2/users/verifyImg'
        }
    },
    methods:{
        handleToLogin(){
            this.axios.post('/api2/users/login',{
                ...
                if(status === 0){
                    ...
                    messageBox({
                        ...
                        ok : '确定',
                        handleOk(){
                            //This.updateverifyTmg = '/api2/users/verifyImg?'+Math.random();
                        }
                    });
                }
            });
